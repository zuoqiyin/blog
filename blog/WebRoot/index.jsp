	...
	<body>
		...
		<div class="menu">
			<ul class="nav-menu clearfix unstyled">
			    <li>
			        <a href="index.jsp" class="three-d active">
			            Home
			    ...
			    <li>
			    	<a href="view/about.jsp" target="view" class="three-d">
			    		about&nbsp;
			    		<div class="three-d-box">
			    ...
			    <li>
			    	<a href="view/timeline.jsp" target="view" class="three-d">
			    		timeline
			    		<div class="three-d-box">
			    ...
			    <li>
			    	<a href="view/message.jsp" target="view" class="three-d">
			    		Feedback
			    		<div class="three-d-box">
		...
		<div class="context">
			<div style="width:700px;float: left;">
				<iframe id="view" name="view" src="main.do" marginheight="0" marginwidth="0" scrolling="no" 
			...
			<div class="right">
				...
				<div class="attention">
					...
					<a href="http://weibo.com/zuoqiyin" target="_blank" title="新浪微博" onmouseover="over(1)" onmouseout="out(1)">
						<img id="logo1" src="img/logo1.png" width="50px" height="50px" style="margin-left: 5px; ">
					</a>
					<a href="http://shang.qq.com/email/stop/email_stop.html?qq=2065820975" target="_blank" title="腾讯QQ" onmouseover="over(2)" onmouseout="out(2)">
						<img id="logo2" src="img/logo2.png" width="50px" height="50px" style="margin-left: 20px;">
					</a>
					<a href="https://github.com/zuoqiyin" target="_blank" title="GitHub" onmouseover="over(3)" onmouseout="out(3)">
						<img id="logo3" src="img/logo3.png" width="50px" height="50px" style="margin-left: 20px;">
					</a>
					<a href="mailto:zuoqy@zuoqy.cn" target="_blank" title="邮箱" onmouseover="over(4)" onmouseout="out(4)">
						<img id="logo4" src="img/logo4.png" width="50px" height="50px" style="margin-left: 20px;">
					</a>
				...
				<img src="img/gg1.jpg" width="280px" height="130px"/>
				...
				<img src="img/gg1.jpg" width="280px" height="110px"/>
			</div>
		</div>
